                ...
                <MenuItems
                    ...
                    <div class="px-1 py-1">
                        ...
                        <button :class="[
                            ...
                            <DocumentDuplicateIcon :active="active" class="mr-2 h-5 w-5 text-violet-400"
                                aria-hidden="true" />
                            Duplicate
                        </button>
                        </MenuItem>
                    ...
                    <div class="px-1 py-1">
                        ...
                        <button :class="[
                            ...
                            <ArrowTopRightOnSquareIcon :active="active" class="mr-2 h-5 w-5 text-violet-400" aria-hidden="true" />
                            Move
                        </button>
                        </MenuItem>
                    </div>
